...
#endif
static Otfc::Device::BusSPI spiBus(OTFC_SPI_0_DEV);
#endif
#if defined(OTFC_I2C_0)
static Otfc::Device::BusI2C i2cBus(WireInstance);
#endif
static Otfc::Device::BusSlave gyroSlaveBus;
static Otfc::Device::GyroMPU6050 mpu6050;
static Otfc::Device::GyroMPU6500 mpu6500;
static Otfc::Device::GyroMPU9250 mpu9250;
static Otfc::Device::GyroLSM6DSO lsm6dso;
static Otfc::Device::GyroICM20602 icm20602;
static Otfc::Device::GyroICM42688 icm42688;
static Otfc::Device::GyroBMI160 bmi160;
static Otfc::Device::GyroICM20948 icm20948;
static Otfc::Device::Mag::MagHMC5883L hmc5883l;
static Otfc::Device::Mag::MagQMC5883L qmc5883l;
static Otfc::Device::Mag::MagQMC5883P qmc5883p;
static Otfc::Device::Mag::MagAK8963 ak8963;
static Otfc::Device::Baro::BaroBMP085 bmp085;
static Otfc::Device::Baro::BaroBMP280 bmp280;
...
{
  for(size_t i = 0; i < Otfc::ACTUATOR_CONDITIONS; i++)
  {
...
static bool isSpiCs0SharedWithGpioOutput(const Otfc::Model& model)
{
  return hasModeCondition(model, Otfc::MODE_GPIO_OUTPUT) &&
         model.config.pin[Otfc::PIN_SPI_CS0] == 5;
}
} // namespace
