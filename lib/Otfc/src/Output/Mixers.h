...
{
public:
  static MixerConfig getMixer(MixerType mixer, const MixerConfig& custom)
  {
    // clang-format off
    // default empty mixer
    ...
    // octox8 mixer (8 motors in X configuration)
    static MixerEntry mixesOctoX8[] = {
      // FL                                     FR                                     BR                                      BL                                      MFL                                     MFR                                     MBR                                     MBL
      MixerEntry(MIXER_SOURCE_ROLL,   0, -100), MixerEntry(MIXER_SOURCE_ROLL,   1, -100), MixerEntry(MIXER_SOURCE_ROLL,   2,  100), MixerEntry(MIXER_SOURCE_ROLL,   3,  100), MixerEntry(MIXER_SOURCE_ROLL,   4, -100), MixerEntry(MIXER_SOURCE_ROLL,   5, -100), MixerEntry(MIXER_SOURCE_ROLL,   6,  100), MixerEntry(MIXER_SOURCE_ROLL,   7,  100),
      MixerEntry(MIXER_SOURCE_PITCH,  0,  100), MixerEntry(MIXER_SOURCE_PITCH,  1, -100), MixerEntry(MIXER_SOURCE_PITCH,  2,  100), MixerEntry(MIXER_SOURCE_PITCH,  3, -100), MixerEntry(MIXER_SOURCE_PITCH,  4,  100), MixerEntry(MIXER_SOURCE_PITCH,  5, -100), MixerEntry(MIXER_SOURCE_PITCH,  6,  100), MixerEntry(MIXER_SOURCE_PITCH,  7, -100),
      MixerEntry(MIXER_SOURCE_YAW,    0, -100), MixerEntry(MIXER_SOURCE_YAW,    1,  100), MixerEntry(MIXER_SOURCE_YAW,    2,  100), MixerEntry(MIXER_SOURCE_YAW,    3, -100), MixerEntry(MIXER_SOURCE_YAW,    4,  100), MixerEntry(MIXER_SOURCE_YAW,    5, -100), MixerEntry(MIXER_SOURCE_YAW,    6, -100), MixerEntry(MIXER_SOURCE_YAW,    7,  100),
      MixerEntry(MIXER_SOURCE_THRUST, 0,  100), MixerEntry(MIXER_SOURCE_THRUST, 1,  100), MixerEntry(MIXER_SOURCE_THRUST, 2,  100), MixerEntry(MIXER_SOURCE_THRUST, 3,  100), MixerEntry(MIXER_SOURCE_THRUST, 4,  100), MixerEntry(MIXER_SOURCE_THRUST, 5,  100), MixerEntry(MIXER_SOURCE_THRUST, 6,  100), MixerEntry(MIXER_SOURCE_THRUST, 7,  100),
      MixerEntry() // terminator
    };
    ...
    switch (mixer)
    {
      ...
      case FC_MIXER_OCTOX8:
        return MixerConfig(8, mixesOctoX8);
