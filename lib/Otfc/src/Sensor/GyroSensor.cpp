...
static constexpr float OTFC_FUZZY_ACCEL_ZERO = 0.05f;
static constexpr float OTFC_FUZZY_GYRO_ZERO = 0.20f;
...
void FAST_CODE_ATTR GyroSensor::calibrate()
{
  ...
  case CALIBRATION_UPDATE:
  {
    ...
    if (deltaAccel.getMagnitude() < OTFC_FUZZY_ACCEL_ZERO && _model.state.gyro.adc.getMagnitude() < OTFC_FUZZY_GYRO_ZERO)
    {
