...
// TODO: move to target
#ifdef OTFC_SERIAL_0
  static Otfc::Device::SerialDeviceAdapter<OTFC_SERIAL_0_DEV_T> _uart0(OTFC_SERIAL_0_DEV);
#endif

#ifdef OTFC_SERIAL_1
  static Otfc::Device::SerialDeviceAdapter<OTFC_SERIAL_1_DEV_T> _uart1(OTFC_SERIAL_1_DEV);
#endif

#ifdef OTFC_SERIAL_2
  static Otfc::Device::SerialDeviceAdapter<OTFC_SERIAL_2_DEV_T> _uart2(OTFC_SERIAL_2_DEV);
#endif

#ifdef OTFC_SERIAL_USB
  static Otfc::Device::SerialDeviceAdapter<OTFC_SERIAL_USB_DEV_T> _usb(OTFC_SERIAL_USB_DEV);
#endif
...
int SerialManager::begin()
{
  ...
  (void)(isUsbPort && hasUsbPort);
    ...
    _model.logger.info().log(F("UART")).log(i).log(spc.id).log(spc.functionMask).log(sdc.baud).log(i == OTFC_SERIAL_DEBUG_PORT).log(sdc.tx_pin).logln(sdc.rx_pin);
  }
